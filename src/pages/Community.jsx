...
const wins = [
  {
    ...
    season: 14,
    avatar: P.t1,
    text: 'Booked my first paid editorial shoot this week. Corella gave me the confidence to pitch myself.',
    supports: 24,
    replies: 6,
    time: '2h ago',
  },
  {
    ...
    season: 12,
    avatar: P.t2,
    text: 'Walked into my interview with runway posture and spoke like I meant it. Got the offer on the spot.',
    supports: 31,
    replies: 8,
    time: '5h ago',
  },
  {
    ...
    season: 18,
    avatar: P.t3,
    text: 'Performed my first spoken word piece in front of 200 people. Hands were shaking but my voice was not.',
    supports: 45,
    replies: 12,
    time: '8h ago',
  },
  {
    ...
    season: 9,
    avatar: P.t4,
    text: 'Three years post-Corella and I still do my Before I Walk every single morning. It changed everything.',
    supports: 58,
    replies: 14,
    time: '1d ago',
  },
  {
    ...
    season: 14,
    avatar: P.t5,
    text: 'Started teaching confidence workshops at my daughter\'s school. Full circle moment.',
    supports: 39,
    replies: 9,
    time: '1d ago',
  },
...
const announcements = [
  {
    title: 'Season 19 Applications Open',
    text: 'Know someone who needs this? Referral slots open for alumni. DM us for the link.',
    time: '1d ago',
    type: 'Opportunity',
  },
  {
    title: 'Studio Hours Extended',
    text: 'Open studio now available Saturdays 10am-4pm for all alumni members.',
    time: '3d ago',
    type: 'Update',
  },
  {
    title: 'Photographer Partnership',
    text: 'Discounted headshots with Alex Rivera Photography — exclusive for Continuum members.',
    time: '5d ago',
    type: 'Opportunity',
  },
  {
    title: 'Community Guidelines Refresh',
    text: 'We updated our win-sharing guidelines. Wins over likes. Always.',
    time: '1w ago',
    type: 'Update',
  },
]
